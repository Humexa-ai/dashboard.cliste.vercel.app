...
const LumaBar = () => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      <div className="relative flex items-center justify-center gap-6 bg-white/20 dark:bg-black/20 backdrop-blur-2xl rounded-full px-6 py-3 shadow-[0_25px_60px_-20px_rgba(59,130,246,0.45)] border border-gray-200/40 dark:border-gray-700/60 overflow-visible">
